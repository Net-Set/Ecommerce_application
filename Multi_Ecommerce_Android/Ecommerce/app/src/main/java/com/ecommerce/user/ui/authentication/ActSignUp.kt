package com.ecommerce.user.ui.authentication
...
import com.ecommerce.user.ui.activity.ActPrivacyPolicy
...
class ActSignUp : BaseActivity(), CountryCodePicker.OnCountryChangeListener {
    ...
    override fun initView() {
        ...
        signUpBinding.tvTermsCondition.setOnClickListener {
            startActivity(
                Intent(this@ActSignUp, ActPrivacyPolicy::class.java).putExtra(
                    "Type",
                    "Terms Condition"
                )
            )
        ...
        if (intent.getStringExtra("loginType") != null) {
            ...
            signUpBinding.tvPass.visibility = View.GONE
    ...
    private fun signup() {
        if (intent.getStringExtra("loginType") != null) {
            if (signUpBinding.edtMobile.text.toString().equals("")) {
                ...
                hasmap["mobile"] ="+"+signUpBinding.ccp.selectedCountryCode+" "+ signUpBinding.edtMobile.text.toString()
            ...
            if (signUpBinding.edtFullname.text.toString() == "") {
                showErrorFullMsg(this@ActSignUp, resources.getString(R.string.validation_all))
            } else if (signUpBinding.edtEmail.text.toString() == "") {
                showErrorFullMsg(this@ActSignUp, resources.getString(R.string.validation_all))
            ...
            } else if (signUpBinding.edtMobile.text.toString() == "") {
                showErrorFullMsg(this@ActSignUp, resources.getString(R.string.validation_all))
            } else if (signUpBinding.edtPassword.text.toString() == "") {
                showErrorFullMsg(this@ActSignUp, resources.getString(R.string.validation_all))
            } else {
                if (signUpBinding.chbTermsCondition.isChecked) {
                    val hasmap = HashMap<String, String>()
    ...
    override fun onCountrySelected(selectedCountry: Country?) {
        val code=signUpBinding.ccp.selectedCountryCode
        Toast.makeText(this@ActSignUp,code,Toast.LENGTH_SHORT).show()
        Log.d("CCPCode",code)
    }
}