...
import com.ecommerce.user.model.FilterDataItem
...
class FilterViewAdapter(
    ...
    private val mList: ArrayList<FilterDataItem>
) :
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        /*  if (viewAll.ratingsAverage == "0") {
              holder.tvRatePro.text =
                  "0.0"
          } else {
              holder.tvRatePro.text =
                  viewAll.ratingsAverage.toString()
          }*/
    }

    //TODO CALL API REMOVE FAVOURITE
    private fun callApiRemoveFavourite(
        viewAll: FilterDataItem,
