...
import com.ecommerce.user.ui.activity.ActCardInfo
...
class ActPaymentMethod : BaseActivity(), PaymentResultListener {
                ...
                override fun onBindData(
                    ...
                    when (paymentDataList[position].paymentName) {
                        "Wallet" -> {
                            ...
                            if (walletAmount.isEmpty()) {
                                binding.tvpaymenttype.text =
                                    getString(R.string.walletpayment) + "(" +
                                            Common.getPrice(
                        ...
                        "COD" -> {
                            ...
                            binding.tvpaymenttype.text = getString(R.string.cashpayment)
                        }
                        ...
                        "RazorPay" -> {
                            ...
                            binding.tvpaymenttype.text = getString(R.string.razorpaypayment)
                        }
                        ...
                        "Stripe" -> {
                            ...
                            binding.tvpaymenttype.text = getString(R.string.stripepayment)
                        }
                        ...
                        "Flutterwave" -> {
                            ...
                            binding.tvpaymenttype.text = getString(R.string.flutterwaveepayment)
                        }
                        ...
                        "Paystack" -> {
                            ...
                            binding.tvpaymenttype.text = getString(R.string.paystackpayment)
                        }
                    }
                }
    ...
    override fun onPaymentSuccess(razorpayPaymentId: String?) {
        try {
            ...
            hasmap["order_notes"] = intent.getStringExtra("order_notes") ?: "0"
            hasmap["grand_total"] = intent.getStringExtra("grand_total")!!
            hasmap["payment_id"] = razorpayPaymentId!!
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (resultCode == RESULT_OK) {
            ...
            val cardNumber = data?.getStringExtra("card_number").toString()
            val expMonth = data?.getStringExtra("exp_month").toString()
            val expYear = data?.getStringExtra("exp_year").toString()
            val cvv = data?.getStringExtra("cvv").toString()
    ...
    //TODO CALL ORDER API
    private fun callApiOrderstripe(cardNumber: String,
                                   expMonth: String,
                                   expYear: String,
                                   cvv: String) {
        showLoadingProgress(this@ActPaymentMethod)
        ...
        hasmap["discount_amount"] = intent.getStringExtra("discount_amount")!!
        hasmap["vendor_id"] = intent.getStringExtra("vendorid")!!
        hasmap["card_number"] = cardNumber
        hasmap["card_exp_month"] = expMonth
        hasmap["card_exp_year"] = expYear
        hasmap["card_cvc"] = cvv
        val call = ApiClient.getClient.setOrderPayment(hasmap)
        call.enqueue(object : Callback<SingleResponse> {
            override fun onResponse(
