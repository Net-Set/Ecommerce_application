...
class MyAccountFragment : BaseFragment<FragAccountBinding>() {
    ...
    override fun initView(view: View) {
        ...
        userid = SharePreference.getStringPref(
            requireActivity(),
        ...
        accountBinding.clSetting.setOnClickListener {
            if (SharePreference.getBooleanPref(requireActivity(), SharePreference.isLogin)) {
                startActivity(
                    Intent(activity, ActSettings::class.java).putExtra(
                        "notificationStatus",
                        notificationStatus
        ...
        if (SharePreference.getBooleanPref(requireActivity(), SharePreference.isLogin)) {
            ...
            accountBinding.tvEmail.visibility = View.GONE
        ...
        accountBinding.clPrivacypolicy.setOnClickListener {
            startActivity(
                Intent(activity, ActPrivacyPolicy::class.java).putExtra(
                    "Type",
                    "Policy"
                )
            )
            ...
            override fun onResponse(
                ...
                if (response.code() == 200) {
                    ...
                    if (restResponce.status == 1) {
                        ...
                        notificationStatus = dataResponse!!.notificationStatus.toString()
                        referralCode = dataResponse!!.referralCode.toString()
