...
interface ApiInterface {
    ...
    @POST("getwishlist")
    fun getWishList( @Query("page") page: String,
                     @Body map: HashMap<String, String>): Call<GetWishListResponse>
    ...
    fun changeNotificationStatus(@Body map: HashMap<String, String>): Call<SingleResponse>
