...
class ActSignUpVendor : BaseActivity() {
    ...
    private fun init() {
        ...
        signUpVendorBinding.tvTermsCondition.setOnClickListener {
            startActivity(
                Intent(this@ActSignUpVendor, ActPrivacyPolicy::class.java).putExtra(
                    "Type",
                    "Terms Condition"
                )
            )
    ...
    private fun signupVendor() {
        ...
        if (signUpVendorBinding.edtFullname.text.toString().equals("")) {
            ...
            if (signUpVendorBinding.chbTermsCondition.isChecked) {
                ...
                hasmap["mobile"] = "+"+signUpVendorBinding.ccp.selectedCountryCode+" "+signUpVendorBinding.edtMobile.text.toString()
