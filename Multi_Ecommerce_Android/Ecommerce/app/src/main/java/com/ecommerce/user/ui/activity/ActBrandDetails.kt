...
class ActBrandDetails : BaseActivity() {
    ...
    private var brandDetailsAdapter: BaseAdaptor<BrandDetailsDataItem, RowGravityBinding>? =
        null
        ...
        brandDetailsAdapter =
            object : BaseAdaptor<BrandDetailsDataItem, RowGravityBinding>(
                ...
                override fun onBindData(
                    ...
                    binding.tvProductPrice.text = Common.getPrice(
                        currencyPosition, currency,
                        branddetailsDataList[position].productPrice!!.toString()
                    )
                    if (branddetailsDataList[position].discountedPrice == "0" || branddetailsDataList[position].discountedPrice == null) {
                        binding.tvProductDisprice.visibility = View.GONE
                    } else {
                        binding.tvProductDisprice.text = Common.getPrice(
                            currencyPosition, currency,
                            branddetailsDataList[position].discountedPrice!!.toString()
                        )
                    }
                    ...
                    Glide.with(this@ActBrandDetails)
                        .load(branddetailsDataList[position].productimage?.imageUrl)
